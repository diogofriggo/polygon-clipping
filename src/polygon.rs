...
/// A collection of points that are arranged into segments to form a closed polygon in 2d space.
/// Points must be ordered counter-clockwise in a y-down, x-right, z-into the screen coordinate
/// system
#[derive(Debug, Clone)]
pub struct Polygon {
